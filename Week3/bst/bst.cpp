/* Errors: This function needed a destructor to get rid of all the pointers
 * that were created.
 * In Insert, root = NULL. Thus we can't insert a val. To fix this, 
 * we have to use if else statements in bool insert (line 128) to consider
 * if root is currently NULL or not.
 */
